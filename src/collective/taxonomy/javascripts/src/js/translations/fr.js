const fr = {
  ...
  backToSettingsLabel: 'Retour aux paramètres',
  changesMade: 'Des changements ont été effectués. Vous devez cliquer sur le ' +
               'bouton "Enregistrer" pour sauvegarder ces changements.',
